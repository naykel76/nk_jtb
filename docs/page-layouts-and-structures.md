    ...
    <div class="container-xl bdr bdr-gray-200">
        <div class="flex">
            ...
            <aside class="w-16 fs-0 flex-col bg-slate-900">
                <!-- Top section (e.g., logo or nav) -->
                <div class="pxy-075 bdr-b bdr-gray-200">
                    <div class="h-2 bg-slate-700 rounded"></div>
                </div>
                <!-- Middle section (e.g., menu items) -->
                <div class="flex-1 pxy-075 space-y">
                    <div class="h-4 bg-slate-700 rounded"></div>
                    <div class="h-10 bg-slate-700 rounded"></div>
                </div>
                <!-- Bottom section (e.g., user/profile) -->
                <div class="pxy-075 bdr-t bdr-gray-200">
                    <div class="h-2 bg-slate-700 rounded"></div>
                </div>
            </aside>
            <!-- Main Content Area -->
