...
renderer.code = function (code, infostring, escaped) {
    ...
    const isDemoFolded = flagsArray.includes('+demo-folded')
    const hasPreview = isDemoFolded || flagsArray.includes('+preview')
    const hasCode = isDemoFolded || flagsArray.includes('+code')
    const isCollapsible = isDemoFolded || flagsArray.includes('+collapse')
